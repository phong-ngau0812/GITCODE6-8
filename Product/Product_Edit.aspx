                        ...
                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-8">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 ">
                                                <div class="form-group">
                                                    <label>SKU hiển thị trên web <span class="red">*</span></label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4" runat="server" id="spbh" visible="false">
                                    <div class="form-group">
                                        <label>Sản phẩm kích hoạt 2 tem</label>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox runat="server" ID="txtCreateDate" ClientIDMode="Static" CssClass="form-control" name="birthday" Text="" />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <%-- <label>Kích hoạt</label>--%>
                                                <div class="custom-control custom-checkbox">
                                                    <asp:CheckBox runat="server" ID="ckisHome" ClientIDMode="Static" />
                            ...
                            <div class="form-group class-label">
                                <asp:CheckBox runat="server" ID="ckShow" Text="Thông tin chi tiết sản phẩm" Checked="true" ClientIDMode="Static" AutoPostBack="true" OnCheckedChanged="ckShow_Checked" />
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="row">
                                            ...
                                            <%-- <label>Kích hoạt</label>--%>
                                            <%-- <div class="custom-control custom-checkbox">
                                                        <asp:CheckBox runat="server" ID="ckisPromotion" ClientIDMode="Static" />
                                                        <label for="ckisNew" class="custom-control-label">
                                                           Khuyến Mãi
                                                        </label>
                                                    </div>
                            ...
                            <div class="form-group mb-0">
                                <asp:Button runat="server" ID="btnSave" ClientIDMode="Static" OnClientClick="return validate();" OnClick="btnSave_Click" CssClass="btn btn-gradient-primary waves-effect waves-light" Text="Lưu" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceBottom" runat="Server">
    ...
    <script>
        ...
        function Init() {
            ...
            $("#ckisPromotion").addClass("custom-control-input");
